...
> For the DirectiveCard preview, I'll render an actual (mocked) DirectiveCard component so the user sees exactly what it looks like. The explanation text below will briefly describe: "Olen suggests your next activity based on your schedule, streaks, and priorities. You'll see this at the top of your dashboard."
